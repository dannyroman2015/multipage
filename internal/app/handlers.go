...
// /item
// //////////////////////////////////////////////////////////
func (s *Server) item(w http.ResponseWriter, r *http.Request, ps httprouter.Params) {
	cus_navbarOpt := Cus_navbarOpt{
		Title: "Item",
		Menus: []Url{
	...
	template.Must(template.ParseFiles("templates/pages/item/item.html", "templates/shared/cus_navbar.html")).Execute(w, map[string]interface{}{
		"cus_navbarOpt": cus_navbarOpt,
	})
}
